...
\begin{figure}[!htp]
\begin{center}
\includegraphics[width=13cm]{Imagenes/SelectionSortVectorRandom.PNG}
\end{center}
\end{figure} 
...
\begin{figure}[!htp]
\begin{center}
\includegraphics[width=13cm]{Imagenes/MergeSortOrdenadodecreciente.PNG}
\end{center}
\end{figure} 

\begin{figure}[!htp]
\begin{center}
\includegraphics[width=13cm]{Imagenes/SelectionSortOrdenadodecreciente.PNG}
\end{center}
\end{figure} 

\begin{figure}[!htp]
\begin{center}
\includegraphics[width=13cm]{Imagenes/MergeSortOrdenadocreciente.PNG}
\end{center}
\end{figure} 

\begin{figure}[!htp]
\begin{center}
\includegraphics[width=13cm]{Imagenes/SelectionSortordenadocreciente.PNG}
\end{center}
\end{figure} 
...
Vale mencionar algunas cosas. Para N chicos, donde los tiempos de ambos métodos son 0 o casi 0, se considera el Speed Up nulo, indicando que los 2 métodos tardaron lo mismo.
